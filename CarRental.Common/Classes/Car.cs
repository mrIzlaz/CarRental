...
public class Car : Vehicle
{
    ...
    public Car(string licencePlate, string manufacturer, int odometer, VehicleType vehicleType, int dayCost,
        double kmCost) : base(licencePlate, manufacturer, odometer, vehicleType, dayCost, kmCost) { }
}